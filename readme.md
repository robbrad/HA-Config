...
I use [GitHub Actions](https://github.com/features/actions). When I commit a change to this repo it kicks off an [automatic test](https://github.com/robbrad/HA-Config/actions) of the config using a Home Assistant environment. See [the results here](https://github.com/robbrad/HA-Config/blob/master/.github/workflows/main.yml).

It's very powerful and can run parallel tests on multiple versions of Python and Home Assistant. I currenlty test Python 3.6 and 3.7 as well as Home Assistant Stable and Beta.
